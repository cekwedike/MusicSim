...
const Header: React.FC<HeaderProps> = ({ artistName, onShowManagementHub, hasUnseenAchievements }) => {
    return (
        <header className="py-4 px-6 md:px-8 text-center border-b border-gray-700/50 relative">
            ...
            {artistName && (
                 <button 
                    ...
                    className="absolute top-1/2 right-4 md:right-6 -translate-y-1/2 text-gray-400 hover:text-white transition-colors duration-200 p-2 rounded-full hover:bg-gray-700"
