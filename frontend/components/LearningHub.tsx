...
const LearningHub: React.FC<LearningHubProps> = ({ isOpen, onClose, onOpenModule, playerKnowledge, gameState, isGuestMode = false }) => {
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-lg sm:rounded-xl p-3 sm:p-4 border border-white/20">
                <div className="grid grid-cols-3 gap-2 sm:gap-3 text-center">
                  ...
                  <div className="transform hover:scale-110 transition-transform duration-200 group relative">
                    ...
                    {/* Tooltip */}
                    <div className="absolute -top-16 left-1/2 transform -translate-x-1/2 bg-[#1A0A0F] text-white text-xs rounded-lg px-3 py-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap z-50 border border-gray-600">
