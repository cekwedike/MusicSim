  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-br from-gray-900 via-purple-900/20 to-gray-900 backdrop-blur-sm flex items-center justify-center z-[70] p-2 sm:p-4 animate-fadeIn">
      <div className="bg-gradient-to-br from-gray-800 via-gray-800 to-gray-900 rounded-lg sm:rounded-2xl w-full max-w-5xl max-h-[98vh] sm:max-h-[95vh] overflow-hidden border border-purple-500/30 shadow-2xl shadow-purple-500/20 flex flex-col">
        ...
        <div className="relative bg-gradient-to-r from-violet-600 via-purple-600 to-fuchsia-600 p-4 sm:p-6 flex-shrink-0">
          ...
          <div className="relative z-10">
            <div className="flex justify-between items-start mb-2 sm:mb-4">
              ...
              <button
                onClick={onClose}
                className="text-purple-200 hover:text-white transition-all duration-200 hover:rotate-90 text-3xl min-w-[44px] min-h-[44px] flex items-center justify-center hover:bg-white/10 rounded-full flex-shrink-0"
                aria-label="Close"
              >
                ×
              </button>
        ...
        <div className="p-3 sm:p-6 overflow-y-auto custom-scrollbar flex-1">
          {!showQuiz && !showQuizResults && (
            <div className={`animate-${sectionDirection === 'forward' ? 'slideInRight' : 'slideInLeft'}`} key={currentSection}>
              ...
              {currentSection === 0 && (
                <div className="mb-6 p-5 bg-gradient-to-r from-purple-900/40 to-violet-900/40 rounded-xl border-l-4 border-purple-500 shadow-lg">
              ...
              <div className="mb-6">
                <h3 className="text-2xl font-bold text-white mb-4 flex items-center gap-3">
                  <span className="w-8 h-8 rounded-full bg-gradient-to-br from-purple-500 to-violet-600 flex items-center justify-center text-sm">
                    {currentSection + 1}
                  </span>
              ...
              {isLastSection && module.content.culturalContext && (
                <div className="mb-6 p-5 bg-gradient-to-br from-purple-900/40 to-pink-900/40 border border-purple-500/30 rounded-xl shadow-lg">
                  <h4 className="text-white font-semibold mb-3 flex items-center gap-2">
                    <svg className="w-5 h-5 text-purple-400" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <p className="text-purple-200 leading-relaxed">{module.content.culturalContext}</p>
                </div>
              )}
          ...
          {showQuiz && !showQuizResults && (
            <div className="animate-fadeIn">
              <div className="mb-8 text-center">
                <div className="inline-block p-4 bg-gradient-to-br from-purple-500 to-violet-600 rounded-full mb-4">
              ...
              {module.quiz.map((question, questionIndex) => (
                <div key={questionIndex} className="mb-6 p-5 bg-gradient-to-br from-gray-700 to-gray-800 border border-gray-600 rounded-xl shadow-lg">
                  <h4 className="text-white font-semibold mb-4 flex items-start gap-3">
                    <span className="flex-shrink-0 w-7 h-7 rounded-full bg-purple-600 flex items-center justify-center text-sm">
                      {questionIndex + 1}
                    </span>
                    ...
                    {question.options.map((option, optionIndex) => (
                      ...
                      >
                        <span className={`flex-shrink-0 w-6 h-6 rounded-full border-2 flex items-center justify-center text-sm font-semibold ${
                          quizAnswers[questionIndex] === optionIndex ? 'border-white bg-white text-purple-600' : 'border-gray-400'
                        }`}>
        ...
        {/* Footer Navigation */}
        <div className="bg-gradient-to-r from-gray-800 to-gray-900 border-t border-purple-500/30 px-6 py-4 flex justify-between items-center">
          {!showQuiz && !showQuizResults && (
            <>
              <button
              ...
              <button
                ...
                className="bg-gradient-to-r from-purple-600 to-violet-600 hover:from-purple-700 hover:to-violet-700 text-white px-6 py-3 rounded-lg transition-all duration-200 font-semibold flex items-center gap-2 shadow-lg hover:shadow-xl hover:scale-105 min-w-[120px]"
              >
