                ...
                <div className="bg-[#3D1820]/50 rounded-lg p-4 mb-4">
                    ...
                    <div className="space-y-2 text-sm">
                        <div className="flex justify-between">
                            ...
                            <span className="text-green-400 font-bold">${(pendingOffer.label.terms?.advance || 0).toLocaleString()}</span>
                        </div>
                        <div className="flex justify-between">
                            <span className="text-gray-400">Royalty Rate:</span>
                            <span className="text-blue-400 font-bold">{pendingOffer.label.terms?.royaltyRate || 0}%</span>
                        </div>
                        <div className="flex justify-between">
                            <span className="text-gray-400">Contract Length:</span>
                            <span className="text-purple-400 font-bold">{pendingOffer.label.terms?.contractLength || 0} years</span>
                        </div>
                    </div>
                </div>
