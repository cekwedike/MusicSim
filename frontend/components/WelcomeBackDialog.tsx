  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center p-4 z-50">
      <div className="bg-gray-800 border-2 border-violet-500 rounded-xl shadow-2xl w-full max-w-md p-8 text-center animate-fade-in">
        ...
        <button
          onClick={onClose}
          className="w-full bg-gradient-to-r from-violet-500 to-fuchsia-500 text-white font-bold py-3 px-6 rounded-lg hover:scale-105 transition-transform shadow-lg"
        >
          Let's Go!
        </button>
      </div>
